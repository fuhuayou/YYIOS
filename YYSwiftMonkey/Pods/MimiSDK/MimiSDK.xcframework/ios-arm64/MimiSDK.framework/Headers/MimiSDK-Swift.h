...
#ifndef MIMISDK_SWIFT_H
#define MIMISDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MimiSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Slider that reflects and updates the current intensity on the active processing handler.
SWIFT_RESILIENT_CLASS("_TtC7MimiSDK29MimiProcessingIntensitySlider")
@interface MimiProcessingIntensitySlider : MimiView
...
/// Toggle button that enables/disables processing on the active processing handler.
SWIFT_RESILIENT_CLASS("_TtC7MimiSDK20MimiProcessingToggle")
@interface MimiProcessingToggle : MimiView
/// :nodoc:
...
SWIFT_RESILIENT_CLASS("_TtC7MimiSDK23MimiProfileLauncherView")
...
/// The profile provides access to all core features of Mimi. Including onboarding, taking a test
/// authenticating an account and interacting with Audio Personalization.
SWIFT_CLASS("_TtC7MimiSDK25MimiProfileViewController")
@interface MimiProfileViewController : UIViewController
