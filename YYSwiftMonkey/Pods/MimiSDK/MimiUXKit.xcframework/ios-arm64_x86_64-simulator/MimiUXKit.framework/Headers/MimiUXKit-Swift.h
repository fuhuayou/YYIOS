...
/// Compact, prominent button which features a label and background color that changes with state.
SWIFT_CLASS("_TtC9MimiUXKit23MimiCompactActionButton")
@interface MimiCompactActionButton : MimiActionButton
@property (nonatomic, readonly) CGSize intrinsicContentSize;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Compact button that appears as a simple label.
SWIFT_CLASS("_TtC9MimiUXKit21MimiCompactTextButton")
@interface MimiCompactTextButton : MimiTextButton
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Footer view that displays a single action button designed for flow progression.
